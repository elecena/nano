...
class DatabaseMysql extends Database
{
    ...
    protected function doConnect()
    {
        ...
        $params = [];
        $keys = ['host', 'user', 'pass', 'database', 'port', 'socket', 'flags'];
        ...
        if (!empty($params)) {
            ...
            $res = @call_user_func_array([$this->link, 'real_connect'], $params);
    ...
    {
        return $this->delete($table, $where, ['limit' => 1]);
    }
    ...
    {
        return $this->insertRows($table, [$row], $options, $fname);
    }
