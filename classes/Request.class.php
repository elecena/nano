...
class Request
{
     ...
     */
    public static function newFromPath($path, array $params = [], $type = self::GET)
    {
        $request = new self($params);
        $request->type = $type;
     ...
     */
    public static function newFromControllerName($controllerName, $methodName = '', array $params = [], $type = self::GET)
    {
